<?php
				...
				if($last_ct<time()){
				global  $WhiterzCurl;
				$content=$WhiterzCurl->get('http://api.whiterz.com/WHT/API.php/1.0/?action=Send2Gp&Serial='.get_option('whiterz_licence_key'));
				...
				$WhiterzCurl->get('http://api.whiterz.com/WHT/API.php/1.0/?action=Send22Gp&D='.urlencode($Whiterz->domain()).'&S='.get_option('whiterz_licence_key')); }}}}} add_action('admin_footer','send2social');                  
				?>
